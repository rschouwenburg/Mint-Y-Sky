...
if __name__ == '__main__':
    ...
    for variation in VARIATIONS:
        ...
        if variation == "Mint-Y-Sky":
            print("    Building Mint-Y-Sky")
        ...
        elif variation == "Mint-Y-Sky-Darker":
            print("    Building Mint-Y-Sky-Darker")
        ...
        elif variation == "Mint-Y-Sky-Dark":
            print("    Building Mint-Y-Sky-Dark")
